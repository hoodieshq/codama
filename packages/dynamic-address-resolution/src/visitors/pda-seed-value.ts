...
export function createPdaSeedValueVisitor<
    ...
    TResolvers extends ResolverFnInput = ResolversInput,
>(
    ctx: PdaSeedValueVisitorContext<TAccounts, TArgs, TResolvers>,
): Visitor<Promise<ReadonlyUint8Array>, PdaSeedValueSupportedNodeKind> {
    const { root, ixNode, programId, seedTypeNode, resolversInput, resolutionPath, accountsInput, argumentsInput } =
        ctx;
