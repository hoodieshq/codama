...
This package provides the address resolution functionality for instruction account of Codama IDL. It powers [`@codama/dynamic-instructions`](../dynamic-instructions/README.md) and [`@codama/dynamic-client`](../dynamic-client/README.md).
...
```ts
import type { TransferSolAccounts, TransferSolArgs } from './generated/types';
