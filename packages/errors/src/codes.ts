...
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CANNOT_CONVERT_TO_ADDRESS = 2500002;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__MISSING_REQUIRED_ACCOUNT = 2500003;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ACCOUNT_ADDRESS = 2500004;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNKNOWN_ENUM_VARIANT = 2500005;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_RESOLVER_MISSING = 2500006;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT = 2500007;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__LINKED_PDA_NOT_FOUND = 2500008;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFINED_TYPE_NOT_FOUND = 2500009;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_PDA_SEED = 2500010;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE = 2500011;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_TYPE_NODE = 2500012;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CONDITIONAL_EVALUATION_FAILED = 2500013;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_REFERENCE_NOT_FOUND = 2500014;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY = 2500015;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__RESOLVER_EXECUTION_FAILED = 2500016;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT = 2500017;
...
export type CodamaErrorCode =
    ...
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_REFERENCE_NOT_FOUND
    ...
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CONDITIONAL_EVALUATION_FAILED
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFINED_TYPE_NOT_FOUND
    ...
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_PDA_SEED
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__LINKED_PDA_NOT_FOUND
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__MISSING_REQUIRED_ACCOUNT
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_NOT_FOUND
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__RESOLVER_EXECUTION_FAILED
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNKNOWN_ENUM_VARIANT
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_TYPE_NODE
