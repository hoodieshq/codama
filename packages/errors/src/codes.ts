...
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_RESOLVER_MISSING = 2500005;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT = 2500006;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE = 2500010;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__NODE_REFERENCE_NOT_FOUND = 2500012;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY = 2500013;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_EXECUTE_RESOLVER = 2500014;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT = 2500015;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ARGUMENT_TYPE = 2500017;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_DERIVE_PDA = 2500018;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNEXPECTED_ADDRESS_TYPE = 2500019;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFAULT_VALUE_MISSING = 2500020;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ARGUMENT_MISSING = 2500021;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_OPTIONAL_ACCOUNT_STRATEGY = 2500022;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_VALIDATE_INPUT = 2500023;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVARIANT_VIOLATION = 2500024;
export const CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_SEED_OUT_OF_RANGE = 2500025;
...
export type CodamaErrorCode =
    ...
    | typeof CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__PDA_SEED_OUT_OF_RANGE
