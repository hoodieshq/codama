...
import {
    ...
    CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CONDITIONAL_EVALUATION_FAILED,
...
export const CodamaErrorMessages: Readonly<{
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_REFERENCE_NOT_FOUND]:
        'Referenced account [$referencedName] not found in [$instructionName].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__ACCOUNT_RESOLVER_MISSING]:
        'Resolver [$resolverName] not provided for account [$accountName]. Provide via .resolvers().',
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CONDITIONAL_EVALUATION_FAILED]:
        'Cannot evaluate conditional for account [$accountName] in [$instructionName]: [$reason].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__DEFINED_TYPE_NOT_FOUND]: 'Cannot resolve defined type link: [$typeName].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT]:
        'Failed to encode argument [$argumentName] in [$instructionName]: [$reason].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INSTRUCTION_NOT_FOUND]:
        'Instruction [$instructionName] not found in IDL. Available: [$available].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ACCOUNT_ADDRESS]: 'Invalid address for [$name]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT]:
        'Invalid argument input for [$argumentName]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_PDA_SEED]:
        'Invalid PDA seed [$seedName] for PDA [$pdaName]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__LINKED_PDA_NOT_FOUND]: 'Linked PDA node [$pdaName] not found.',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__MISSING_REQUIRED_ACCOUNT]:
        'Missing required account [$accountName] in [$instructionName] instruction.',
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNKNOWN_ENUM_VARIANT]:
        'Unknown enum variant [$variant]. Available: [$available].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE]:
        'Unsupported node kind [$nodeKind] while resolving [$context].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_TYPE_NODE]: 'Unsupported type node [$nodeKind] in [$parentKind].',
