...
export const CodamaErrorMessages: Readonly<{
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CANNOT_RESOLVE_OPTIONAL_ACCOUNT]:
        'Cannot resolve optional account [$accountName] in [$instructionName]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__CIRCULAR_ACCOUNT_DEPENDENCY]: 'Circular dependency detected: [$chain].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_ENCODE_ARGUMENT]:
        'Failed to encode argument [$argumentName] in [$instructionName]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_EVALUATE_CONDITIONAL]:
        'Cannot evaluate conditional for account [$accountName] in [$instructionName]: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__FAILED_TO_EXECUTE_RESOLVER]:
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_ARGUMENT_INPUT]: 'Invalid argument input: [$details].',
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__INVALID_PDA_SEED]:
    ...
    [CODAMA_ERROR__DYNAMIC_INSTRUCTIONS__UNSUPPORTED_NODE]: 'Unsupported node kind [$nodeKind]: [$details].',
